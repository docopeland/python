...
# software development environment (DOESN't WORK WITH INTELLIJ)
...
for thresh in range(0,257,64):
    ...
    binarize(Image.open('readonly:Noisy_OCR.PNG'), thresh).show()
...
little_sign.resize(new_size, Image.NEAREST).show()
